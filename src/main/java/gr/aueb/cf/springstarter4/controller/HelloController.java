...
import jakarta.validation.Valid; // κανονικά δουλεύει με javax
...
public class HelloController {
    ...
    public String getMessage(@RequestParam("title") String title, Model model) {
       if (title.equals("CF")) {
           ...
           model.addAttribute("error", "There is an error in request param");
           return "error";
       }
    }

    @RequestMapping(path ="/student/insert", method = RequestMethod.GET)
    public String geStudentForm(Model model) {
